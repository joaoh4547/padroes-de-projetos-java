...
public class MastercardCommunicatorFactory implements CommunicatorFactory {
    ...
    public Issuer createIssuer() {
        return issuerCreator.create(CardType.MASTERCARD);
    }

    @Override
    public Receiver createReceiver() {
        return receiverCreator.create(CardType.MASTERCARD);
    }
}
